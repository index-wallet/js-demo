...
function isCustomerOf(potentialCustomer, potentialVendor) {
	...
	for (let { dir, offset } of directions) {
		let targetI = potentialCustomer.i + offset.i;
		let targetJ = potentialCustomer.j + offset.j;
		...
		if (
			...
			grid[potentialCustomer.i][potentialCustomer.j][dir]
		) {
			return true;
		}
	}
